    ...
    <nav class="p-4 space-y-6">
        ...
        <div>
            ...
            <ul class="space-y-1">
                ...
                <li>
                    <a href="{{ route('admin.ai-training.index') }}"
                       class="flex items-center px-3 py-2.5 rounded-hando text-sm font-medium transition-colors duration-150
                              {{ request()->routeIs('admin.ai-training.*') ? 'bg-purple-50 dark:bg-purple-900/20 text-purple-600 border-l-4 border-purple-500' : 'text-hando-gray-600 dark:text-hando-gray-400 hover:bg-hando-gray-100 dark:hover:bg-hando-gray-700' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="{{ route('admin.forbidden-words.index') }}"
                       class="flex items-center px-3 py-2.5 rounded-hando text-sm font-medium transition-colors duration-150
                              {{ request()->routeIs('admin.forbidden-words.*') ? 'bg-red-50 dark:bg-red-900/20 text-red-600 border-l-4 border-red-500' : 'text-hando-gray-600 dark:text-hando-gray-400 hover:bg-hando-gray-100 dark:hover:bg-hando-gray-700' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="{{ route('admin.activity-logs.index') }}"
                       class="flex items-center px-3 py-2.5 rounded-hando text-sm font-medium transition-colors duration-150
                              {{ request()->routeIs('admin.activity-logs.*') ? 'bg-blue-50 dark:bg-blue-900/20 text-hando-primary border-l-4 border-hando-primary' : 'text-hando-gray-600 dark:text-hando-gray-400 hover:bg-hando-gray-100 dark:hover:bg-hando-gray-700' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
>
    ...
    <div class="h-16 flex items-center px-6 border-b border-hando-border-light dark:border-hando-border-dark">
        <a href="{{ route('dashboard') }}" class="flex items-center space-x-3">
            <div class="w-8 h-8 bg-gradient-to-br from-hando-primary to-blue-600 rounded-lg flex items-center justify-center">
                <span class="text-white font-bold text-lg">H</span>
            </div>
            <span class="text-xl font-bold text-hando-text-light dark:text-hando-text-dark">Hando</span>
        </a>
    </div>
